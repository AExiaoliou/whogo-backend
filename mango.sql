...
CREATE TABLE `sys_teacher` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `user_name` varchar(50) DEFAULT NULL COMMENT '用户名',
  `workid` varchar(50) DEFAULT NULL COMMENT '工号',
  ...
  `last_update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2804 DEFAULT CHARSET=utf8 COMMENT='教职工表';
...
CREATE TABLE `sys_student` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `user_name` varchar(50) DEFAULT NULL COMMENT '用户名',
  `workid` varchar(50) DEFAULT NULL COMMENT '学号',
  `sex` bigint(20) DEFAULT NULL COMMENT '性别',
  `create_by` varchar(50) DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `last_update_by` varchar(50) DEFAULT NULL COMMENT '更新人',
  `last_update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2804 DEFAULT CHARSET=utf8 COMMENT='学生表';
...
CREATE TABLE `sys_book` (
  ...
  `last_update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2804 DEFAULT CHARSET=utf8 COMMENT='图书表';

-- ----------------------------
-- Table structure for sys_bookmember
-- ----------------------------
DROP TABLE IF EXISTS `sys_bookmember`;
CREATE TABLE `sys_bookmember` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '编号',
  ...
  `last_update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2804 DEFAULT CHARSET=utf8 COMMENT='图书会员表';

-- ----------------------------
-- Table structure for sys_cafe
-- ----------------------------
DROP TABLE IF EXISTS `sys_cafe`;
CREATE TABLE `sys_cafe` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `name` varchar(50) DEFAULT NULL COMMENT '菜品',
  ...
  `last_update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2804 DEFAULT CHARSET=utf8 COMMENT='食堂菜品表';

-- ----------------------------
-- Table structure for sys_cafemember
-- ----------------------------
DROP TABLE IF EXISTS `sys_cafemember`;
CREATE TABLE `sys_cafemember` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `name` varchar(50) DEFAULT NULL COMMENT '用户名',
  `price` bigint(20) DEFAULT NULL COMMENT '余额',
  `create_by` varchar(50) DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `last_update_by` varchar(50) DEFAULT NULL COMMENT '更新人',
  `last_update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2804 DEFAULT CHARSET=utf8 COMMENT='食堂会员表';